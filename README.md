...
![Execution LaZagne](lazagne_attack.jpg)
...
![Detection Timeline](limacharlie_detection.png)
...
![User Prompt Decision](user_prompt.png)
...
![Ping Failure Isolation](ping_failure.png)
...
![Slack Confirmation Success](slack_alert.jpg)
